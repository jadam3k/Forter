...
## Features
- Nice microcontroller for nice projects ;)

## 3D Model
<img width="934" height="862" alt="image" src="https://github.com/user-attachments/assets/19dd82b9-c03e-4cb9-866b-eef275b7859b" />
<img width="945" height="845" alt="image" src="https://github.com/user-attachments/assets/f0abef1a-bc35-4e41-a6e7-817a07d8a8c9" />



## PCB

<img width="754" height="739" alt="image" src="https://github.com/user-attachments/assets/23c784ed-4e13-4219-8b9c-7047cd72eaba" />
...
- `/PCB` – source CAD files and exported STEP model
- `BOM.csv` – bill of materials with links

  Because This is not cad project and im only making pcb im staying with that
